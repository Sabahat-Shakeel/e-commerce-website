...
import Link from "next/link";
 ...
 export default function Makeup1() {
  return (
    <div className="sm:inline-table lg:ml-6 inline-table  ">
      <BackgroundGradient className="rounded-[22px] max-w-lg p-4 sm:p-10 bg-white dark:bg-slate-950">
        <Link href = "/makeup">
        <Image
          src="/m1.jpg"
          alt="makeup gallery"
