...
export function MensCard() {
  return (
    <div className=" lg:ml-6 sm:inline-table inline-table ">
      <BackgroundGradient className="text-xs rounded-[22px] max-w-lg p-4 sm:p-10 bg-white dark:bg-zinc-900">
        <Image
          src="/j1.jpg"
        ...
        <button className="rounded-full pl-4 pr-1 py-1 text-black flex items-center space-x-1 bg-white mt-4 text-xs font-bold dark:bg-zinc-50 hover:bg-black hover:text-white">
          <span>Buy now </span>
