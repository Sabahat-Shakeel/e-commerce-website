...
export default function MensCard2() {
  return (
    <div className="sm:inline-table lg:ml-16  lg:px-4 inline-table  ">
      <BackgroundGradient className="rounded-[22px] max-w-lg p-4 sm:p-10 bg-white dark:bg-zinc-900">
        ...
        <p className="text-xs text-neutral-600 dark:text-neutral-400">
          The just-in style for the new session. Explore the new classics. Your best opportunity to get these right now is by
          entering raffles and waiting for the official releases.
        </p>
        <button className="rounded-full pl-4 pr-1 py-1 text-black flex items-center space-x-1 hover:bg-black hover:text-white bg-white mt-4 text-xs font-bold dark:bg-zinc-50">
          <span>Buy now </span>
